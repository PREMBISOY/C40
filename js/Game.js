...
player.getRank();
    ...
    if(player.distance>4300){
      ...
      Player.plrRankUpdate(player.rank);
  ...
  winnigMsg = createElement('h1');
   winningMsg.position(displayWidth/2,);
   winnigMsg.html('YOU WON');
   rankMsg = createElement('h1');
   rankMsg.position( 400,displayHeight/2);
   rankMsg.html('YOU ARE ON '+player.rank+' POSITION');
  game.update(2);
}
